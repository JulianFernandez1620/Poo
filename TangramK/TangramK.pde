...
void pintarTriangulo1 (){
 ...
 if((dist(posxT,posyT,mouseX,mouseY)<radioc) && (mousePressed) ) {
   if(posxT2!=mouseX && posxT3!=mouseX && posxT4!=mouseX && posxT21!=mouseX && posxC!=mouseX && posxTr!=mouseX) { 
     if(posyT2!=mouseY && posyT3!=mouseY && posyT4!=mouseY && posyT21!=mouseY && posyC!=mouseY && posyTr!=mouseY){
    posxT = mouseX;
    posyT = mouseY;
   }
 }
...
void pintarTriangulo2 (){
 ...
 if((dist(posxT2,posyT2,mouseX,mouseY)<radioc) && (mousePressed)){
   if(posxT!=mouseX && posxT3!=mouseX && posxT4!=mouseX && posxT21!=mouseX && posxC!=mouseX && posxTr!=mouseX) { 
     if(posyT!=mouseY && posyT3!=mouseY && posyT4!=mouseY && posyT21!=mouseY && posyC!=mouseY && posyTr!=mouseY){
   posxT2 = mouseX;
    posyT2 = mouseY;
 }
 }
...
void pintarTriangulo3 (){
 ...
 if((dist(posxT3,posyT3,mouseX,mouseY)<radioc) && (mousePressed)){
   if(posxT!=mouseX && posxT2!=mouseX && posxT4!=mouseX && posxT21!=mouseX && posxC!=mouseX && posxTr!=mouseX) { 
     if(posyT!=mouseY && posyT2!=mouseY && posyT4!=mouseY && posyT21!=mouseY && posyC!=mouseY && posyTr!=mouseY){
    posxT3 = mouseX;
    posyT3 = mouseY;
 }
   }
...
void pintarTriangulo4 (){
 ...
 if((dist(posxT4,posyT4,mouseX,mouseY)<radioc) && (mousePressed)){
   if(posxT!=mouseX && posxT2!=mouseX && posxT3!=mouseX && posxT21!=mouseX && posxC!=mouseX && posxTr!=mouseX) { 
     if(posyT!=mouseY && posyT2!=mouseY && posyT3!=mouseY && posyT21!=mouseY && posyC!=mouseY && posyTr!=mouseY){
    posxT4 = mouseX;
    posyT4 = mouseY;
 }
   }
...
void pintarTriangulo21(){
  ...
  if((dist(posxT21,posyT21,mouseX,mouseY)<radioc) && (mousePressed)){
    if(posxT!=mouseX && posxT2!=mouseX && posxT4!=mouseX && posxT3!=mouseX && posxC!=mouseX && posxTr!=mouseX) { 
     if(posyT!=mouseY && posyT2!=mouseY && posyT4!=mouseY && posyT3!=mouseY && posyC!=mouseY && posyTr!=mouseY){
    posxT21 = mouseX;
    posyT21 = mouseY;
  }
    }
...
void pintarCuadrado(){
  ...
  if((dist(posxC,posyC,mouseX,mouseY)<radioc) && (mousePressed)){
    if(posxT!=mouseX && posxT2!=mouseX && posxT4!=mouseX && posxT21!=mouseX && posxT3!=mouseX && posxTr!=mouseX) { 
     if(posyT!=mouseY && posyT2!=mouseY && posyT4!=mouseY && posyT21!=mouseY && posyT3!=mouseY && posyTr!=mouseY){
    posxC = mouseX;
    posyC = mouseY;
  }
    }
...
void pintarTrapecio(){
 ...
 if((dist(posxTr,posyTr,mouseX,mouseY)<radioc) && (mousePressed)){
   if(posxT!=mouseX && posxT2!=mouseX && posxT4!=mouseX && posxT21!=mouseX && posxC!=mouseX && posxT3!=mouseX) { 
     if(posyT!=mouseY && posyT2!=mouseY && posyT4!=mouseY && posyT21!=mouseY && posyC!=mouseY && posyT3!=mouseY){
    posxTr = mouseX;
    posyTr = mouseY;
 }
   }
